...
app.layout = html.Div(children=[
    ...
    html.Div([
        html.Div([
            dbc.Row(
                dbc.Col(
                    html.H1('Corona Tracker', id="n-c", style=sn),
...
#                        html.Iframe(src="https://thunder2020.pythonanywhere.com/timeline", width=500, height=800),
                        dbc.Button(dbc.CardImg(src=app.get_asset_url('bar_g.jpg')), href='https://thunder2020.pythonanywhere.com/timeline'),
                        dbc.CardBody([
                ...
                html.Div([
                    dbc.Card([
                        dbc.Button(dbc.CardImg(src=app.get_asset_url('counter_g.jpg')), href='https://thunder2020.pythonanywhere.com/counter'),
                        dbc.CardBody([
                ...
                html.Div([
                    dbc.Card([
                        dbc.Button(dbc.CardImg(src=app.get_asset_url('table_g.jpg')), href='https://thunder2020.pythonanywhere.com/table'),
                        dbc.CardBody([
            ...
            html.Div([
                dbc.Card([
                    dbc.Button(dbc.CardImg(src=app.get_asset_url('map_g.jpg')), href='https://thunder2020.pythonanywhere.com/map'),
                    dbc.CardBody([
                ...
                dbc.Card([
                    dbc.Button(dbc.CardImg(src=app.get_asset_url('growth.png')), href='https://thunder2020.pythonanywhere.com/growth'),
                    dbc.CardBody([
                ...
                dbc.Card([
                    dbc.Button(dbc.CardImg(src=app.get_asset_url('Infocentre.png')), href='https://thunder2020.pythonanywhere.com/infocentre'),
                    dbc.CardBody([
